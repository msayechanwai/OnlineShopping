...
<head>
    ...
    <link rel="icon" type="text/css" href="{{ asset('images/classic-logo.jpg') }}">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <!-- Shopping Cart -->
                        <a href="{{ url("/product/shoppingCart") }}" class="btn btn-outline-dark" style="background-color: #f89224;">
