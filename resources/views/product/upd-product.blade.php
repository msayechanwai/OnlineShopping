                    ...
                    <form action="{{ url("/admin/product/update/$product->id") }}"  method="post" enctype="multipart/form-data">
                        ...
                        <table class="table table-sm">
                            ...
                            <tr>
                                ...
                                <td><img width="50px" height="50px" src="{{ asset("images/$product->photo") }}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input class="form-control" type="text" name="qty" value="{{ $product->qty }}"></td>
                            </tr>


                            <tr>
                                <td><label class="form-control">Remark:</label></td>
                                <td><input class="form-control" type="text" name="remark" value="{{ $product->remark }}"></td>
                            </tr>
